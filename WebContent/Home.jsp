...
<div style="width: 101.5%; height: 104%; margin: -26px 0px -10px -10px; background-clip: padding-box; background-image: url('./ETH_image.png'); background-size: auto 100%; text-shadow:3px 3px 10px #FFFFFF;">
